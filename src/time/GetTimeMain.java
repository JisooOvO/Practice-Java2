...
public class GetTimeMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("dt.get(ChronoField.MICRO_OF_DAY) = " + dt.get(ChronoField.MINUTE_OF_DAY));
        System.out.println("dt.get(ChronoField.MICRO_OF_DAY) = " + dt.get(ChronoField.SECOND_OF_DAY));
    }
